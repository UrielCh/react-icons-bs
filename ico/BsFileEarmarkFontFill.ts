...
/**
 * FileEarmarkFontFill icon from Bootstrap Icons
 * @module
 */
export function BsFileEarmarkFontFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFileEarmarkFontFill;
