...
/**
 * FileEarmarkCheckFill icon from Bootstrap Icons
 * @module
 */
export function BsFileEarmarkCheckFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFileEarmarkCheckFill;
