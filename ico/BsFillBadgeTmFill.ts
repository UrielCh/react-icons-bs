...
/**
 * FillBadgeTmFill icon from Bootstrap Icons
 * @module
 */
export function BsFillBadgeTmFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillBadgeTmFill;
