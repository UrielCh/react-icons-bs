...
/**
 * FillBadgeCcFill icon from Bootstrap Icons
 * @module
 */
export function BsFillBadgeCcFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillBadgeCcFill;
