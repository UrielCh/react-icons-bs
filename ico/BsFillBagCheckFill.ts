...
/**
 * FillBagCheckFill icon from Bootstrap Icons
 * @module
 */
export function BsFillBagCheckFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillBagCheckFill;
