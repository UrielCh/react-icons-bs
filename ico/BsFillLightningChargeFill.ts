...
/**
 * FillLightningChargeFill icon from Bootstrap Icons
 * @module
 */
export function BsFillLightningChargeFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillLightningChargeFill;
