...
/**
 * SignNoParkingFill icon from Bootstrap Icons
 * @module
 */
export function BsSignNoParkingFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsSignNoParkingFill;
