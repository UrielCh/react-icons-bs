...
/**
 * FillCalendar2CheckFill icon from Bootstrap Icons
 * @module
 */
export function BsFillCalendar2CheckFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillCalendar2CheckFill;
