...
/**
 * FillPieChartFill icon from Bootstrap Icons
 * @module
 */
export function BsFillPieChartFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillPieChartFill;
