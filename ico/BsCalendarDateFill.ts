...
/**
 * CalendarDateFill icon from Bootstrap Icons
 * @module
 */
export function BsCalendarDateFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsCalendarDateFill;
