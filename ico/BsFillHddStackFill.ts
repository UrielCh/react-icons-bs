...
/**
 * FillHddStackFill icon from Bootstrap Icons
 * @module
 */
export function BsFillHddStackFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillHddStackFill;
