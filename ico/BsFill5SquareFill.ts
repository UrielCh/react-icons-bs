...
/**
 * Fill5SquareFill icon from Bootstrap Icons
 * @module
 */
export function BsFill5SquareFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFill5SquareFill;
