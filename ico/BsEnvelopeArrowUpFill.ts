...
/**
 * EnvelopeArrowUpFill icon from Bootstrap Icons
 * @module
 */
export function BsEnvelopeArrowUpFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsEnvelopeArrowUpFill;
