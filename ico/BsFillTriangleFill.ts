...
/**
 * FillTriangleFill icon from Bootstrap Icons
 * @module
 */
export function BsFillTriangleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillTriangleFill;
