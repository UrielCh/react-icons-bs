...
/**
 * Calendar2DayFill icon from Bootstrap Icons
 * @module
 */
export function BsCalendar2DayFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsCalendar2DayFill;
