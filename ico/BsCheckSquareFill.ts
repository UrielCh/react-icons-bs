...
/**
 * CheckSquareFill icon from Bootstrap Icons
 * @module
 */
export function BsCheckSquareFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsCheckSquareFill;
