...
/**
 * FillCcSquareFill icon from Bootstrap Icons
 * @module
 */
export function BsFillCcSquareFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillCcSquareFill;
