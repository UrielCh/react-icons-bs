...
/**
 * PatchQuestionFill icon from Bootstrap Icons
 * @module
 */
export function BsPatchQuestionFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsPatchQuestionFill;
