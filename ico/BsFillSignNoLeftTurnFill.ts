...
/**
 * FillSignNoLeftTurnFill icon from Bootstrap Icons
 * @module
 */
export function BsFillSignNoLeftTurnFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillSignNoLeftTurnFill;
