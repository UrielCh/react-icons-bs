...
/**
 * FillCheckSquareFill icon from Bootstrap Icons
 * @module
 */
export function BsFillCheckSquareFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillCheckSquareFill;
