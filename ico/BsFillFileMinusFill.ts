...
/**
 * FillFileMinusFill icon from Bootstrap Icons
 * @module
 */
export function BsFillFileMinusFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillFileMinusFill;
