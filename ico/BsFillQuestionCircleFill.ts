...
/**
 * FillQuestionCircleFill icon from Bootstrap Icons
 * @module
 */
export function BsFillQuestionCircleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillQuestionCircleFill;
