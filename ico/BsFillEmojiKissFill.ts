...
/**
 * FillEmojiKissFill icon from Bootstrap Icons
 * @module
 */
export function BsFillEmojiKissFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillEmojiKissFill;
