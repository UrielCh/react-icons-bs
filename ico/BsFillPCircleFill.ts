...
/**
 * FillPCircleFill icon from Bootstrap Icons
 * @module
 */
export function BsFillPCircleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillPCircleFill;
