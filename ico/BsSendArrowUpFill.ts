...
/**
 * SendArrowUpFill icon from Bootstrap Icons
 * @module
 */
export function BsSendArrowUpFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsSendArrowUpFill;
