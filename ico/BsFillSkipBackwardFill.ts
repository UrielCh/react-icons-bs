...
/**
 * FillSkipBackwardFill icon from Bootstrap Icons
 * @module
 */
export function BsFillSkipBackwardFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillSkipBackwardFill;
