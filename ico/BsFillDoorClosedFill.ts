...
/**
 * FillDoorClosedFill icon from Bootstrap Icons
 * @module
 */
export function BsFillDoorClosedFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillDoorClosedFill;
