...
/**
 * FillSignYieldFill icon from Bootstrap Icons
 * @module
 */
export function BsFillSignYieldFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillSignYieldFill;
