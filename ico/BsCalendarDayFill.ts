...
/**
 * CalendarDayFill icon from Bootstrap Icons
 * @module
 */
export function BsCalendarDayFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsCalendarDayFill;
