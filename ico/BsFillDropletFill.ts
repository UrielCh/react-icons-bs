...
/**
 * FillDropletFill icon from Bootstrap Icons
 * @module
 */
export function BsFillDropletFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillDropletFill;
