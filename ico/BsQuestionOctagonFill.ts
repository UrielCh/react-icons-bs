...
/**
 * QuestionOctagonFill icon from Bootstrap Icons
 * @module
 */
export function BsQuestionOctagonFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsQuestionOctagonFill;
