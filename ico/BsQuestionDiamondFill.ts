...
/**
 * QuestionDiamondFill icon from Bootstrap Icons
 * @module
 */
export function BsQuestionDiamondFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsQuestionDiamondFill;
