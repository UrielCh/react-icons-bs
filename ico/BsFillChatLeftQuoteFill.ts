...
/**
 * FillChatLeftQuoteFill icon from Bootstrap Icons
 * @module
 */
export function BsFillChatLeftQuoteFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillChatLeftQuoteFill;
