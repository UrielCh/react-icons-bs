...
/**
 * FillDashCircleFill icon from Bootstrap Icons
 * @module
 */
export function BsFillDashCircleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillDashCircleFill;
