...
/**
 * FillEvStationFill icon from Bootstrap Icons
 * @module
 */
export function BsFillEvStationFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillEvStationFill;
