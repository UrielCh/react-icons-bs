...
/**
 * FillPatchQuestionFill icon from Bootstrap Icons
 * @module
 */
export function BsFillPatchQuestionFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillPatchQuestionFill;
