...
/**
 * ChatLeftQuoteFill icon from Bootstrap Icons
 * @module
 */
export function BsChatLeftQuoteFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsChatLeftQuoteFill;
