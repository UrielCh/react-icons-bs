...
/**
 * FileEarmarkSlidesFill icon from Bootstrap Icons
 * @module
 */
export function BsFileEarmarkSlidesFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFileEarmarkSlidesFill;
