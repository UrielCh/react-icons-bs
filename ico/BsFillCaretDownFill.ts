...
/**
 * FillCaretDownFill icon from Bootstrap Icons
 * @module
 */
export function BsFillCaretDownFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillCaretDownFill;
