...
/**
 * FillHouseUpFill icon from Bootstrap Icons
 * @module
 */
export function BsFillHouseUpFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillHouseUpFill;
