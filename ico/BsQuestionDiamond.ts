...
/**
 * QuestionDiamond icon from Bootstrap Icons
 * @module
 */
export function BsQuestionDiamond(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsQuestionDiamond;
