...
/**
 * FillCaretRightFill icon from Bootstrap Icons
 * @module
 */
export function BsFillCaretRightFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillCaretRightFill;
