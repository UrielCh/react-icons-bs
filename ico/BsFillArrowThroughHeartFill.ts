...
/**
 * FillArrowThroughHeartFill icon from Bootstrap Icons
 * @module
 */
export function BsFillArrowThroughHeartFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillArrowThroughHeartFill;
