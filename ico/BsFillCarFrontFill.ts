...
/**
 * FillCarFrontFill icon from Bootstrap Icons
 * @module
 */
export function BsFillCarFrontFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillCarFrontFill;
