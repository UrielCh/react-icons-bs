...
/**
 * FillCaretLeftFill icon from Bootstrap Icons
 * @module
 */
export function BsFillCaretLeftFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillCaretLeftFill;
