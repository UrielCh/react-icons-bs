...
/**
 * SlashSquareFill icon from Bootstrap Icons
 * @module
 */
export function BsSlashSquareFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsSlashSquareFill;
