...
/**
 * FillEnvelopeOpenFill icon from Bootstrap Icons
 * @module
 */
export function BsFillEnvelopeOpenFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillEnvelopeOpenFill;
