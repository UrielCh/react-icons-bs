...
/**
 * FillHandThumbsUpFill icon from Bootstrap Icons
 * @module
 */
export function BsFillHandThumbsUpFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillHandThumbsUpFill;
