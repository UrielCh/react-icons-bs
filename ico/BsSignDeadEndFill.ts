...
/**
 * SignDeadEndFill icon from Bootstrap Icons
 * @module
 */
export function BsSignDeadEndFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsSignDeadEndFill;
