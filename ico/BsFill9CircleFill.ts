...
/**
 * Fill9CircleFill icon from Bootstrap Icons
 * @module
 */
export function BsFill9CircleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFill9CircleFill;
