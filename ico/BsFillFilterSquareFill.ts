...
/**
 * FillFilterSquareFill icon from Bootstrap Icons
 * @module
 */
export function BsFillFilterSquareFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillFilterSquareFill;
