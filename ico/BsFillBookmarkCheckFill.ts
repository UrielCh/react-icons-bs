...
/**
 * FillBookmarkCheckFill icon from Bootstrap Icons
 * @module
 */
export function BsFillBookmarkCheckFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillBookmarkCheckFill;
