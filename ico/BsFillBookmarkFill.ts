...
/**
 * FillBookmarkFill icon from Bootstrap Icons
 * @module
 */
export function BsFillBookmarkFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillBookmarkFill;
