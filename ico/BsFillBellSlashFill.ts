...
/**
 * FillBellSlashFill icon from Bootstrap Icons
 * @module
 */
export function BsFillBellSlashFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillBellSlashFill;
