...
/**
 * FillXSquareFill icon from Bootstrap Icons
 * @module
 */
export function BsFillXSquareFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillXSquareFill;
