...
/**
 * Calendar2CheckFill icon from Bootstrap Icons
 * @module
 */
export function BsCalendar2CheckFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsCalendar2CheckFill;
