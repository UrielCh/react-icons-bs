...
/**
 * FillMarkdownFill icon from Bootstrap Icons
 * @module
 */
export function BsFillMarkdownFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillMarkdownFill;
