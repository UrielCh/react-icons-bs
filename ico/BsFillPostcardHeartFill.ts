...
/**
 * FillPostcardHeartFill icon from Bootstrap Icons
 * @module
 */
export function BsFillPostcardHeartFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillPostcardHeartFill;
