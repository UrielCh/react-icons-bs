...
/**
 * FillFileEarmarkWordFill icon from Bootstrap Icons
 * @module
 */
export function BsFillFileEarmarkWordFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillFileEarmarkWordFill;
