...
/**
 * FillEmojiHeartEyesFill icon from Bootstrap Icons
 * @module
 */
export function BsFillEmojiHeartEyesFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillEmojiHeartEyesFill;
