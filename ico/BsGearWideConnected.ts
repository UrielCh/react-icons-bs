...
/**
 * GearWideConnected icon from Bootstrap Icons
 * @module
 */
export function BsGearWideConnected(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsGearWideConnected;
