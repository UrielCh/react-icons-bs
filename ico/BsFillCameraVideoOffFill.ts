...
/**
 * FillCameraVideoOffFill icon from Bootstrap Icons
 * @module
 */
export function BsFillCameraVideoOffFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillCameraVideoOffFill;
