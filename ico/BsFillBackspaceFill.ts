...
/**
 * FillBackspaceFill icon from Bootstrap Icons
 * @module
 */
export function BsFillBackspaceFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillBackspaceFill;
