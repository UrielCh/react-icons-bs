...
/**
 * QuestionSquareFill icon from Bootstrap Icons
 * @module
 */
export function BsQuestionSquareFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsQuestionSquareFill;
