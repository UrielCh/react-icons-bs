...
/**
 * SearchHeartFill icon from Bootstrap Icons
 * @module
 */
export function BsSearchHeartFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsSearchHeartFill;
