...
/**
 * QuestionCircleFill icon from Bootstrap Icons
 * @module
 */
export function BsQuestionCircleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsQuestionCircleFill;
