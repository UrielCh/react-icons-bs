...
/**
 * Fill3CircleFill icon from Bootstrap Icons
 * @module
 */
export function BsFill3CircleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFill3CircleFill;
