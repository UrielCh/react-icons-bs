...
/**
 * FillInboxesFill icon from Bootstrap Icons
 * @module
 */
export function BsFillInboxesFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillInboxesFill;
