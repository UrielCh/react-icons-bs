...
/**
 * FillThreadsFill icon from Bootstrap Icons
 * @module
 */
export function BsFillThreadsFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillThreadsFill;
