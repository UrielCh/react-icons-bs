...
/**
 * FillEnvelopePaperFill icon from Bootstrap Icons
 * @module
 */
export function BsFillEnvelopePaperFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillEnvelopePaperFill;
