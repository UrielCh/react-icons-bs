...
/**
 * FillEmojiSmileFill icon from Bootstrap Icons
 * @module
 */
export function BsFillEmojiSmileFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillEmojiSmileFill;
