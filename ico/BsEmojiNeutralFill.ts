...
/**
 * EmojiNeutralFill icon from Bootstrap Icons
 * @module
 */
export function BsEmojiNeutralFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsEmojiNeutralFill;
