...
/**
 * FillEnvelopeArrowUpFill icon from Bootstrap Icons
 * @module
 */
export function BsFillEnvelopeArrowUpFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillEnvelopeArrowUpFill;
