...
/**
 * Fill2CircleFill icon from Bootstrap Icons
 * @module
 */
export function BsFill2CircleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFill2CircleFill;
