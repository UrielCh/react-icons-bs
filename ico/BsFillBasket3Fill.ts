...
/**
 * FillBasket3Fill icon from Bootstrap Icons
 * @module
 */
export function BsFillBasket3Fill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillBasket3Fill;
