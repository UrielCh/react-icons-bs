...
/**
 * FillPentagonFill icon from Bootstrap Icons
 * @module
 */
export function BsFillPentagonFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillPentagonFill;
