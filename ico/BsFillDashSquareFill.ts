...
/**
 * FillDashSquareFill icon from Bootstrap Icons
 * @module
 */
export function BsFillDashSquareFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillDashSquareFill;
