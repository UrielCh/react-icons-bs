...
/**
 * FillFileBreakFill icon from Bootstrap Icons
 * @module
 */
export function BsFillFileBreakFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillFileBreakFill;
