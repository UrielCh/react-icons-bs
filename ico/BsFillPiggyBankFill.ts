...
/**
 * FillPiggyBankFill icon from Bootstrap Icons
 * @module
 */
export function BsFillPiggyBankFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillPiggyBankFill;
