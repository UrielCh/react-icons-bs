...
/**
 * FillFileWordFill icon from Bootstrap Icons
 * @module
 */
export function BsFillFileWordFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillFileWordFill;
