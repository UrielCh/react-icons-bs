...
/**
 * Calendar2PlusFill icon from Bootstrap Icons
 * @module
 */
export function BsCalendar2PlusFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsCalendar2PlusFill;
