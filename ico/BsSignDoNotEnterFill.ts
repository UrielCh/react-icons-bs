...
/**
 * SignDoNotEnterFill icon from Bootstrap Icons
 * @module
 */
export function BsSignDoNotEnterFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsSignDoNotEnterFill;
