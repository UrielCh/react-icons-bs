...
/**
 * ChatSquareQuoteFill icon from Bootstrap Icons
 * @module
 */
export function BsChatSquareQuoteFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsChatSquareQuoteFill;
