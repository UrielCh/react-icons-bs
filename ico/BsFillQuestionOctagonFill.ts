...
/**
 * FillQuestionOctagonFill icon from Bootstrap Icons
 * @module
 */
export function BsFillQuestionOctagonFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillQuestionOctagonFill;
