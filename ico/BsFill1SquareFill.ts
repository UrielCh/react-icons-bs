...
/**
 * Fill1SquareFill icon from Bootstrap Icons
 * @module
 */
export function BsFill1SquareFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFill1SquareFill;
