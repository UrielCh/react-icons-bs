...
/**
 * FillCalendarDayFill icon from Bootstrap Icons
 * @module
 */
export function BsFillCalendarDayFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillCalendarDayFill;
