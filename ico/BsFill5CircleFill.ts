...
/**
 * Fill5CircleFill icon from Bootstrap Icons
 * @module
 */
export function BsFill5CircleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFill5CircleFill;
