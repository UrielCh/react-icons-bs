...
/**
 * SortNumericDown icon from Bootstrap Icons
 * @module
 */
export function BsSortNumericDown(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsSortNumericDown;
