...
/**
 * HandThumbsUpFill icon from Bootstrap Icons
 * @module
 */
export function BsHandThumbsUpFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsHandThumbsUpFill;
