...
/**
 * EnvelopeArrowDownFill icon from Bootstrap Icons
 * @module
 */
export function BsEnvelopeArrowDownFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsEnvelopeArrowDownFill;
