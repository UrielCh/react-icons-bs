...
/**
 * FillCaretUpFill icon from Bootstrap Icons
 * @module
 */
export function BsFillCaretUpFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillCaretUpFill;
