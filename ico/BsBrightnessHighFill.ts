...
/**
 * BrightnessHighFill icon from Bootstrap Icons
 * @module
 */
export function BsBrightnessHighFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsBrightnessHighFill;
