...
/**
 * FillSendArrowUpFill icon from Bootstrap Icons
 * @module
 */
export function BsFillSendArrowUpFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillSendArrowUpFill;
