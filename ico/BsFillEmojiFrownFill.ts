...
/**
 * FillEmojiFrownFill icon from Bootstrap Icons
 * @module
 */
export function BsFillEmojiFrownFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillEmojiFrownFill;
