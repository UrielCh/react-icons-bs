...
/**
 * FillCcCircleFill icon from Bootstrap Icons
 * @module
 */
export function BsFillCcCircleFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillCcCircleFill;
