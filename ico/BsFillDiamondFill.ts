...
/**
 * FillDiamondFill icon from Bootstrap Icons
 * @module
 */
export function BsFillDiamondFill(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default BsFillDiamondFill;
